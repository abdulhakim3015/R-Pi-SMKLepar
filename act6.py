...
st. set_page_config(page_title="Dashboard DIY: Data Visualization",
layout="centered")
...
value_counts = df['sex' ]. value_counts() # Calculate the counts for each
gender
...
## 3. Find distribution of averge total_bill across each day by male and
female
# bar, area, line
...
# visual
fig, ax = plt. subplots ()
avg_total_bill.plot(kind='bar', ax=ax, colormap='viridis',
edgecolor='black')
